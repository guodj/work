pro read_amie_binary, amiefile, data, lats, mlts, ut, fields, imf,	$
  ...
  if (strpos(amiefile,"save") gt 0) then begin
      ...
      for i=0,ntimes-1 do begin
          ...
          readu,11,n,iyr_tmp,imo_tmp,ida_tmp,ihr_tmp,imi_tmp
          ...
          readu,11,swv_tmp,bx_tmp,by_tmp,bz_tmp, $
      ...
      version = 2.0
      if (not eof(11)) then readu,11,version
