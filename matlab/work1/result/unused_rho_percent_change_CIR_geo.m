...
density_log_actual
mytype='perc';
% percent change of mass density
% 250 km
...
h=[];
h(1)=subplot(3,2,1);
myplot_errorbar_text(d250r_ie_eq,d250r_ie_eq_num,...
    d250r_ei_eq,d250r_ei_eq_num,yr1)

h(2)=subplot(3,2,2);
myplot_errorbar_text(d250r_ie_so,d250r_ie_so_num,...
    d250r_ei_so,d250r_ei_so_num,yr1)

h(3)=subplot(3,2,3);
myplot_errorbar_text(d400r_ie_eq,d400r_ie_eq_num,...
    d400r_ei_eq,d400r_ei_eq_num,yr2)

h(4)=subplot(3,2,4);
myplot_errorbar_text(d400r_ie_so,d400r_ie_so_num,...
    d400r_ei_so,d400r_ei_so_num,yr2)

h(5)=subplot(3,2,5);
myplot_errorbar_text(d550r_ie_eq,d550r_ie_eq_num,...
    d550r_ei_eq,d550r_ei_eq_num,yr3)

h(6)=subplot(3,2,6);
myplot_errorbar_text(d550r_ie_so,d550r_ie_so_num,...
    d550r_ei_so,d550r_ei_so_num,yr3)
...
picname='rho_percent_change_CIR_geo.eps';
