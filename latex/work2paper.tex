...
\section{Data and Method}
    ...
    The events investigated in this work are the earth passage of the solar wind sector boundary, which are defined
    by . The zero epoch time
    assigned to these events is 0000 UT on the day when the solar wind sector changes its polarity to 
