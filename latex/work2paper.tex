...
\section{Data and Method}
    ...
    The events investigated in this work are the earth passage of the solar wind sector boundary, which is defined
    by \citet{Svalgaard1976}.
    The zero epoch time assigned to these events is 0000 UT on the day when the solar wind sector polarity changes 
    from away from to toward the sun or the opposite. 
