...
\begin{abstract} 
    ...
    variations. More importantly, the south pole passes near the cusp location at about 1530 UT every day. Our results
...
\section{Introduction}
    ...
    density variations near the cusp region. 
    ...
    In this paper, we mainly used thermospheric densities near the geographic poles, which are derived from
    the accelerometer onboard the Gravity Recovery and Climate Experiment (GRACE) satellite. 
    A superposed epoch analysis were conducted to the data to present the UT variation of the thermospheric density. 
    In addition, the solar wind sector and solar activity dependences of the UT variation are also addressed.

\section{Data and Method}
    In this study, we used the version 2.3 data for GRACE accelerometer-derived thermospheric total mass 
    densities during the years 2002-2010 \citet{Sutton2011}. 
    ...
    Therefore the GRACE satellite passes near the south or north geographic poles 15 times in any specified day, which could
    well include the UT variations.
    The initial altitude of the GRACE satellite is approximately 500 km, and it gradually decreases to about 475 km
    in 2010. 
    The height drop during this time period is relatively smaller than the CHAMP satellite.
    \citet{Lei2010a} found that the thermospheric density response to external forcings is associated with the distance 
    from the energy deposition  altitude. 
    \citet
