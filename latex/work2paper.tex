...
\section{Data and Method}
    ...
    \citet{Clemmons2008} used the measurements from the Streak mission, and their results show the 
    density is depleted in the cusp relative the sorrounding area, which they interpreted as an altitude effect.
    The GRACE satellite is prefered to the CHAMP satellite partly due to the smaller height drop.
    Therefore the altitude effect is 
